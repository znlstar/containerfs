...
*License*: Apache License v2.0 https://github.com/tigcode/containerfs/blob/master/LICENSE[https://github.com/tigcode/containerfs/blob/master/LICENSE]

*Source control repositories*: https://github.com/tigcode/containerfs[https://github.com/tigcode/containerfs] (everything in the org)

*Initial Committers*: bladehliu jsonkey zhengxiaochuan-3 jls502

*Infrastructure requirements (CI / CNCF Cluster)*:

* Travis https://travis-ci.org/tigcode/containerfs[https://travis-ci.org/tigcode/containerfs]
